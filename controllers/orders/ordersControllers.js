...
exports.updateOrderStatus = (req, res) => {
  ...
  db.query(query, [order_status, orderId], (err, result) => {
    ...
    if (order_status == 'delivered') {
      getWhatsappReciverFromDb(orderId).then((response) => {
        ...
        sendWhatsAppMsg({
          ...
          payStatus: response.payment_status,
          goods: response.types_of_goods,
          dropLocation: response.delivery_location_address,
          type: 'delivered'
        })
      })
    }
